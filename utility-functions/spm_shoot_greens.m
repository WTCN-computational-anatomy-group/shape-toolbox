...
% Slightly modified version that allows an additional "boundary" argument.
% It is unused for now, but might be used someday for different kinds of
% boundary conditions (sliding...)
