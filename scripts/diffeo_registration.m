function opt = diffeo_registration(opt)
% FORMAT opt = diffeo_registration(opt)
%
...
% It can also be used as input to specify initial starting points.
    ...
    opt.dat.llv = llPriorVelocity(opt.dat.v, ...
