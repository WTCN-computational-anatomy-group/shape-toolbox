...
% their fields.
    ...
    % Run algorithm
    prva_model(input,opt);

end

% Temporary help
function show_instructions
    descr_str = 'Train a shape model on a set of 2D or 3D images (PGRA)';
    usg_str   = 'Usage: pgra_train input.json opt.json';
