...
% FORMAT opt = pgra_model_default(opt)
%
...
%     end
    ...
    if ~isfield(opt.optimise.r, 'r')
        opt.optimise.r.r = true;
    end
    ...
    if ~isfield(opt.ondisk.model.pg, 'g')
        opt.ondisk.model.pg.g = true;
    end
    if ~isfield(opt.ondisk.model.pg, 'h')
        opt.ondisk.model.pg.h = true;
    end
    if ~isfield(opt.ondisk.model.pg, 'd')
        opt.ondisk.model.pg.d = true;
    end
    ...
    if ~isfield(opt.fnames.model.pg, 'g')
        opt.fnames.model.pg.g = 'grad_subspace.nii';
    end
    if ~isfield(opt.fnames.model.pg, 'h')
        opt.fnames.model.pg.h = 'hess_subspace.nii';
    end
    if ~isfield(opt.fnames.model.pg, 'd')
        opt.fnames.model.pg.d = 'dir_subspace.nii';
    end
